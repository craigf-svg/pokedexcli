...
func (c *Client) CatchPokemon(pokemon string) (PokemonResult, error) {
	if pokemon == "" {
			fmt.Println("Must type a pokemon to catch")
	...
	return decodePokemonResult(body)
}
...
func decodeExploreResult(data []byte) (ExploreResult, error) {
    var locationData ExploreResult
...
func decodePokemonResult(data []byte) (PokemonResult, error) {
